...
export type InteractiveRoleType = 'reactions' | 'buttons' | 'select';
export type InteractiveRoleAction = 'add' | 'remove' | 'toggle';
export type InteractiveRoleStyle = 'PRIMARY' | 'SECONDARY' | 'SUCCESS' | 'DANGER';
